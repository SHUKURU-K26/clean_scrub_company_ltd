  ...
  return (
    <div className="space-y-5">
      ...
      <div className="rounded-2xl glass p-4 sm:p-5">
        ...
        <DataTable columns={columns} data={filtered} onRowClick={setViewingTx} emptyMessage="No stock-in entries match your filters" />
      ...
      <StockInFormModal open={formOpen} onClose={() => setFormOpen(false)} />
